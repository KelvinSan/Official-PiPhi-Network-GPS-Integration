...
import { clearRuntimeError, getActiveConfigs, getDiagnosticsSummary, getHealthSummary, getRecentEvents, getRuntimeContext, getRuntimeSnapshot, noteTelemetry, recordRuntimeEvent, removeActiveConfig, resetRuntimeForTests, setMqttStatus, setRuntimeError, setRuntimeStatus, updateDeviceRuntime, upsertActiveConfig, } from "../lib/runtime.js";
test.afterEach(() => {
...
test("runtime snapshot is cloned before returning", () => {
    ...
    const again = getRuntimeSnapshot();
