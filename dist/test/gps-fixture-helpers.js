...
export function buildGsaSentence(fixMode = "3", hdop = "1.5", pdop = "1.8", vdop = "0.9") {
    return buildSentence(`GPGSA,A,${fixMode},04,05,09,12,24,25,29,31,,,,${pdop},${vdop},${hdop}`);
}
export function assertApproximate(actual, expected, epsilon = 0.000001) {
